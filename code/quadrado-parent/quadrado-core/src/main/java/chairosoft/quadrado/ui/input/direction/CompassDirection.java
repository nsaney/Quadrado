...
public enum CompassDirection
{
    ...
    private static CompassDirection[] VALUES =
    {
        EAST, 
        NORTHEAST, 
        NORTH, 
    ...
    //     {
    //         throw new Exception("Must have even number of rotating values for CompassDirection.");
    //     }
    // }
    ...
    private CompassDirection(int _value, int _x, int _y, CardinalAlignment _alignment)
    {
        this.VALUE         = _value; 
    ...
    public static CompassDirection getByValue(int _value) { return VALUES[_value]; }
    
    public static CompassDirection combineDirections
    (
    ...
    public static CompassDirection combineDirections_usingSwitch
    (
        CompassDirection directionA,
        CompassDirection directionB
    )
    ...
    public CompassDirection getClockwiseNeighbor() { return this.getClockwiseRotation(1); }
    public CompassDirection getCounterclockwiseNeighbor() { return this.getCounterclockwiseRotation(1); }
    
    public CompassDirection getClockwiseRotation(int units) { return this.getCounterclockwiseRotation(-units); }
    public CompassDirection getCounterclockwiseRotation(int units)
    {
