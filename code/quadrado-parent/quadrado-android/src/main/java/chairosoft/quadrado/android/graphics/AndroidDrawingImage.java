...
public class AndroidDrawingImage extends DrawingImage
{
    ...
    public AndroidDrawingImage(Bitmap _image) {
        this.image = _image;
    }
    
    public AndroidDrawingImage(int w, int h, Config c)
    {
        Bitmap.Config bitmapConfig = AndroidDrawingImage.getBitmapConfig(c);
        this.image = Bitmap.createBitmap(w, h, bitmapConfig);
    }
    
    public AndroidDrawingImage(InputStream in) throws IOException
    {
    ...
    {
        Bitmap subImage = Bitmap.createBitmap(this.image, x, y, w, h);
        return new AndroidDrawingImage(subImage);
    }
}