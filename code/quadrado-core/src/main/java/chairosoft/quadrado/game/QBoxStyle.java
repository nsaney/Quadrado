...
public class QBoxStyle
{
    ...
    public static class BorderWidths
    {
        ...
        public static BorderWidths parse(Element xmlBorderWidths)
        {
            ...
            AttributeValue<Integer> attrTop = new AttributeValue<>(xmlBorderWidths, "top", new RangedIntAttributeParser("top", min, max));
            AttributeValue<Integer> attrRight = new AttributeValue<>(xmlBorderWidths, "right", new RangedIntAttributeParser("right", min, max));
            AttributeValue<Integer> attrBottom = new AttributeValue<>(xmlBorderWidths, "bottom", new RangedIntAttributeParser("bottom", min, max));
            AttributeValue<Integer> attrLeft = new AttributeValue<>(xmlBorderWidths, "left", new RangedIntAttributeParser("left", min, max));
    ...
    public static class BorderLengths
    {
        ...
        public static BorderLengths parse(Element xmlBorderLengths)
        {
            ...
            AttributeValue<Integer> attrHorizontal = new AttributeValue<>(xmlBorderLengths, "horizontal", new RangedIntAttributeParser("horizontal", min, max));
            AttributeValue<Integer> attrVertical = new AttributeValue<>(xmlBorderLengths, "vertical", new RangedIntAttributeParser("vertical", min, max));
