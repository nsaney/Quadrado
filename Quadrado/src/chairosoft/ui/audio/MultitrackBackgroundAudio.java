...
public abstract class MultitrackBackgroundAudio implements Closeable
{
    ...
    static
    {
        ...
        SystemLifecycleHelpers.get().addApplicationCloseHook(new Thread()
        {
    ...
    public static MultitrackBackgroundAudio create()
    {
        MultitrackBackgroundAudio result = Dependencies.getNew(MultitrackBackgroundAudio.class);
        result.init();
        return result;
    }
